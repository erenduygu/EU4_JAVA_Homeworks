...
public class Task047_RealEstateCalculator {
	...
	public static void main(String[] args) {
	   ...
	   System.out.println("Enter your property type:");
		...
		if (houseType.equals("Single Family Home")) {propertyPrice+=95000;}
	...
	System.out.println("Do you have a backyard?");
				...
				else if (true){propertyPrice+=5000;}
	...
	if (metroAccessibility>1&&metroAccessibility<3) {propertyPrice+=5000;}
	...
	if (highwayAccessibility>1&&highwayAccessibility<=5) {propertyPrice+=8000;}
	if (highwayAccessibility>5&&highwayAccessibility<=20) {propertyPrice+=4000;}	
